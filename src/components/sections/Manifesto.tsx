...
export function Manifesto() {
  ...
  return (
    ...
    >
      {/* Subtle dot pattern — kept from the previous polish iteration. No
          burger photo, no aggressive overlays. The typography is the heroine. */}
      ...
      {/* Long vertical padding extends the scroll range — gives every word
          time to colour before the block exits the viewport. */}
